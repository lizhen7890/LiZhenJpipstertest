...
public class LiZhenJpipstertestApp {

    private static final Logger log = LoggerFactory.getLogger(LiZhenJpipstertestApp.class);

    private final Environment env;

    public LiZhenJpipstertestApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes LiZhenJpipstertest.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(LiZhenJpipstertestApp.class);
